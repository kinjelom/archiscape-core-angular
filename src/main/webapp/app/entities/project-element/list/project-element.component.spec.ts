...
describe('ProjectElement Management Component', () => {
  let comp: ProjectElementComponent;
  let fixture: ComponentFixture<ProjectElementComponent>;
  let service: ProjectElementService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'project-element', component: ProjectElementComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ProjectElementComponent, '')
      .compileComponents();
